"""Train the SVM classifier for the waste dataset."""
...
class SVMTrainer:
    """SVM trainer with unknown-class rejection."""
    ...
    def predict_with_rejection(self, X, return_confidence=False):
        """Predict with optional rejection based on margins."""
